...
from metrics import calculate_metrics, save_metrics, plot_loss, save_fold_metric, plot_roc_curves
        ...
        for epoch in range(config['num_epochs']):
            ...
            with torch.no_grad():
                for batch in tqdm(val_loader, desc="Validation"):
                    ...
                    # Extract features for t-SNE from last epoch
                    ...
                    if valid_hc_pd_mask.any():
                        ...
                        probs_hc = F.softmax(valid_logits_hc, dim=1)[:, 1]  # Probability of positive class
                        preds_hc = torch.argmax(valid_logits_hc, dim=1)
                    ...
                    if valid_pd_dd_mask.any():
                        ...
                        # Get probabilities for ROC curve
                        probs_pd = F.softmax(valid_logits_pd, dim=1)[:, 1]  # Probability of positive class
                        preds_pd = torch.argmax(valid_logits_pd, dim=1)
